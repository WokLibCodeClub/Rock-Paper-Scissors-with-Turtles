...
The first task in our new ```play_again()``` function task list was to clear the labelling and hide the two turtles which display the hands for You and Computer:

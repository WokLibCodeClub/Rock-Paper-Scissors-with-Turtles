...
It turns out that if we calculate modulo division by 3 for the numbers 1 and -2 both give the same answer, which is 1. These are the two possible answers for you winning the game if you compute the answer to ```your_choice - computer_choice```. 
